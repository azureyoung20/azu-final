...
from progress.densenet_baseline import MODELS  # Assuming this is the correct import for your model
import torchvision.models as models
def predict_patch(patch_path, model_path):
    # Load the model
...
model_path = 'F:/Dissertation/论文撰写/实验结果材料/name_of_archive/densenet_baseline720/best.ckpt'
cfg_path = 'F:/Dissertation/论文撰写/实验结果材料/name_of_archive/densenet_baseline720/cfg.json'
predicted_class = predict_patch(patch_path, model_path)
